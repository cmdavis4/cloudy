...
def call_npy_to_vdb(
    ...
    command_template = Template(
        """/home/cmdavis4/programs/miniforge3/condabin/conda run -n vdb python -c \"from common.vdb.npy_to_vdb import npy_to_vdb; npy_to_vdb('{{ output_dir }}', {{ tolerance }}, wind_vectors={{ wind_vectors }}, verbose={{ verbose }})\"""".strip()
    )
