...
class TestDataClasses:
    ...
    def test_pv_config_animation_validation(self):
        ...
        with patch("common_experimental.pvplotting.plotter.initialize_plotter"):
...
class TestTrajectoryData:
    ...
    def test_trajectory_data_parcel_limit(self):
        ...
        with pytest.warns(UserWarning, match="Limiting to 100 trajectories"):
            traj_data = PVTrajectoryData(trajectory_ds=ds, n_parcel_limit=100, varspecs=())
...
class TestMeshCreation:
    ...
    @patch(
        "common_experimental.pvplotting.core_pvplotting.generate_trajectory_meshes_single_mesh"
    )
